...
def get_cos_sample_data(nrows, ncols, k):
    """ get synthetic data for cos
...
def get_test_paramters_dictionary():
    test_parameters = {
        'test_directory': '.',
        'method': 'cc_net_cluster_cos',
        'method_1': 'cluster_cos',
        'method_2': 'cc_cluster_cos',
        'method_3': 'net_cluster_cos',
        'method_4': 'cc_net_cluster_cos',
